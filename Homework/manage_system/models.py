...
class Classlist(models.Model):
    ...
    班级表
    如：
    python全栈 面授班 5期 10000 2017-11-11
    '''
...
class Customer(models.Model):
    ...
    experience = models.IntegerField(verbose_name='工作经验', choices=education_choices, null=True, blank=True)
    work_status_choices = [
        (1, '在职'),
        (2, '无业')
    ]
...
class ConsultRecord(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name='追踪人', to='UserInfo', on_delete=models.CASCADE)
...
class PaymentRecord(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name='课程顾问', to='UserInfo', help_text='谁签的单填谁', on_delete=models.CASCADE)
    pay_type_choices = [
        (1, '报名费'),
        (2, '学费'),
        (3, '退学'),
...
class Student(models.Model):
    ...
    mobile = models.CharField(verbose_name='联系电话', max_length=32)
    ...
    student_status = models.IntegerField(verbose_name='学员状态', choices=students_status_choices, default=1)
...
class ScoreRecord(models.Model):
    ...
    score = models.IntegerField('分值', help_text='最终得分')
...
class HomeWorkStudentRecord(models.Model):
    '''
    学生作业记录
    '''
    student = models.ForeignKey(verbose_name='学员', to='Student', on_delete=models.CASCADE)
    course_record = models.ForeignKey(verbose_name='第几天课程', to='CourseRecord', on_delete=models.CASCADE)
    homework = models.TextField(verbose_name='作业', blank=True, null=True)
    score = models.IntegerField('分值', help_text='最终得分',default=0)
    avatar = models.FileField(verbose_name='上传文件',upload_to='avatars/')
